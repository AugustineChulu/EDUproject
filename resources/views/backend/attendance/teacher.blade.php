                ...
                <div class="flex flex-wrap items-center">
                    ...
                    @foreach ($teacher->classes as $class)
                        ...
                        <div class="w-full sm:w-1/2 text-center border border-gray-400 rounded">
                            ...
                            <a href="{{ route('teacher.attendance.create',$class->id) }}" class="bg-green-600 inline-block mb-4 text-xs text-white uppercase font-semibold px-4 py-2 border border-gray-200 rounded">
                                Manage Attendence
                            </a>
                        </div>
