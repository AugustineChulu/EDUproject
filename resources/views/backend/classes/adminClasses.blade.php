            ...
            @foreach ($classes as $class)
                ...
                <div class="flex flex-wrap items-center text-gray-700 border-t-2 border-l-4 border-r-4 border-gray-300">
                    ...
                    <div class="w-2/12 flex items-center justify-end px-3">
                        ...
                        <a href="{{ route('classes.edit',$class->id) }}" title="Edit" class="text-white ml-2 bg-blue-600 block px-2 py-1 rounded">
                            <i class="fa-solid fa-pen"></i>
                        </a>

                        <a href="{{ route('class.assign.subject',$class->id) }}" title="Assign Subject" class="text-white ml-2 bg-green-600 block px-2 py-1 rounded">
