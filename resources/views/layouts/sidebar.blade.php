<div class="sidebar hidden sm:block w-0 sm:w-1/6 h-screen fixed top-0 left-0 bottom-0 z-40 overflow-hidden">
    ...
    <div class="mb-6 pt-4">
        ...
        <a href="{{ route('dashboard') }}" class="flex items-center text-gray-600 py-3 hover:text-gray-200 sidebarTab" tab="home">
        ...
        <a href="{{ route('dashboard') }}" class="flex items-center text-gray-600 py-3 hover:text-gray-200 sidebarTab">
